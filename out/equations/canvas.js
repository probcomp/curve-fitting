...
goog.provide('equations.canvas');
goog.require('cljs.core');
goog.require('reagent.core');
goog.require('re_frame.core');
cljs.core.enable_console_print_BANG_.call(null);
equations.canvas.transform_context = (function equations$canvas$transform_context(ctx,center_x,center_y,scale_x,scale_y){
...
equations.canvas.add_relations = (function equations$canvas$add_relations(config){
var c = config;
...
equations.canvas.make_graph = (function equations$canvas$make_graph(){
var canvas = document.getElementById("plot");
var graph = equations.canvas.add_relations.call(null,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"canvas","canvas",-1798817489),canvas,new cljs.core.Keyword(null,"min-x","min-x",-1544012261),(-10),new cljs.core.Keyword(null,"min-y","min-y",-1969872948),(-10),new cljs.core.Keyword(null,"max-x","max-x",1609536425),(10),new cljs.core.Keyword(null,"max-y","max-y",1525628082),(10),new cljs.core.Keyword(null,"units-per-tick","units-per-tick",-1345919743),(1)], null));
var ctx = new cljs.core.Keyword(null,"canvas","canvas",-1798817489).cljs$core$IFn$_invoke$arity$1(graph).getContext("2d");
ctx.globalCompositeOperation = "multiply";

return cljs.core.assoc.call(null,graph,new cljs.core.Keyword(null,"context","context",-830191113),equations.canvas.transform_context.call(null,ctx,new cljs.core.Keyword(null,"center-x","center-x",2109659472).cljs$core$IFn$_invoke$arity$1(graph),new cljs.core.Keyword(null,"center-y","center-y",-233780987).cljs$core$IFn$_invoke$arity$1(graph),new cljs.core.Keyword(null,"scale-x","scale-x",-13535878).cljs$core$IFn$_invoke$arity$1(graph),new cljs.core.Keyword(null,"scale-y","scale-y",1326124277).cljs$core$IFn$_invoke$arity$1(graph)));
});
equations.canvas.add_equation_BANG_ = (function equations$canvas$add_equation_BANG_(graph,equation,opacity){
...
equations.canvas.add_point_BANG_ = (function equations$canvas$add_point_BANG_(graph,coords){
var ctx = new cljs.core.Keyword(null,"context","context",-830191113).cljs$core$IFn$_invoke$arity$1(graph);
...
equations.canvas.re_trigger_timer = (function equations$canvas$re_trigger_timer(){
...
equations.canvas.convert_scales = (function equations$canvas$convert_scales(event,graph){
...
equations.canvas.re_trigger_timer.call(null);
...
equations.canvas.toggle_animation_button = (function equations$canvas$toggle_animation_button(){
...
equations.canvas.add_equation_button = (function equations$canvas$add_equation_button(){
...
equations.canvas.plot_inner = (function equations$canvas$plot_inner(){
...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"click","click",1912301393),equations.canvas.convert_scales.call(null,event,cljs.core.deref.call(null,graph))], null));
});})(graph))
], null)], null)], null);
});})(graph))
,new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (graph){
return (function (comp){
var g = equations.canvas.make_graph.call(null);
...
var equations__$1 = cljs.core.get.call(null,map__1182__$1,new cljs.core.Keyword(null,"equations","equations",1884238648));
...
cljs.core.run_BANG_.call(null,((function (map__1182,map__1182__$1,equations__$1,points,graph){
return (function (p1__1180_SHARP_){
return equations.canvas.add_equation_BANG_.call(null,cljs.core.deref.call(null,graph),new cljs.core.Keyword(null,"equation","equation",-499527745).cljs$core$IFn$_invoke$arity$1(p1__1180_SHARP_),new cljs.core.Keyword(null,"opacity","opacity",397153780).cljs$core$IFn$_invoke$arity$1(p1__1180_SHARP_));
});})(map__1182,map__1182__$1,equations__$1,points,graph))
,equations__$1);

return cljs.core.run_BANG_.call(null,((function (map__1182,map__1182__$1,equations__$1,points,graph){
return (function (p1__1181_SHARP_){
return equations.canvas.add_point_BANG_.call(null,cljs.core.deref.call(null,graph),p1__1181_SHARP_);
});})(map__1182,map__1182__$1,equations__$1,points,graph))
,points);
});})(graph))
,new cljs.core.Keyword(null,"display-name","display-name",694513143),"plot-inner"], null));
});
equations.canvas.plot_outer = (function equations$canvas$plot_outer(){
var equations__$1 = re_frame.core.subscribe.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"equations","equations",1884238648)], null));
...
return ((function (equations__$1,points){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [equations.canvas.plot_inner,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"equations","equations",1884238648),cljs.core.deref.call(null,equations__$1),new cljs.core.Keyword(null,"points","points",-1486596883),cljs.core.deref.call(null,points)], null)], null);
});
;})(equations__$1,points))
});
equations.canvas.ui = (function equations$canvas$ui(){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"main","main",-2117802661),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"mdl-layout__content"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"mdl-grid"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"mdl-cell--12-col"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [equations.canvas.add_equation_button], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [equations.canvas.toggle_animation_button], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding","padding",1660304693),"16px"], null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [equations.canvas.plot_outer], null)], null)], null)], null)], null);
});
equations.canvas.run = (function equations$canvas$run(){
...
return reagent.core.render.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [equations.canvas.ui], null),document.getElementById("app"));
});
goog.exportSymbol('equations.canvas.run', equations.canvas.run);
equations.canvas.run.call(null);
