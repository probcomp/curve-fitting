...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__1045 = cljs.core.instance_QMARK_;
var expr__1046 = reactive_val;
if(cljs.core.truth_(pred__1045.call(null,reagent.ratom.RAtom,expr__1046))){
return "ra";
} else {
if(cljs.core.truth_(pred__1045.call(null,reagent.ratom.RCursor,expr__1046))){
return "rc";
} else {
if(cljs.core.truth_(pred__1045.call(null,reagent.ratom.Reaction,expr__1046))){
return "rx";
} else {
if(cljs.core.truth_(pred__1045.call(null,reagent.ratom.Track,expr__1046))){
return "tr";
} else {
return "other";
}
